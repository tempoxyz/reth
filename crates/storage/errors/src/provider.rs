...
pub enum ProviderError {
    ...
    UnsupportedProvider,
    /// RocksDB transaction was required but not provided.
    ///
    /// This occurs when storage settings indicate data should be in RocksDB,
    /// but no RocksDB transaction was created (indicates a logic error).
